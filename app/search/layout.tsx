  ...
  return (
    <>
      <div className="mx-auto flex max-w-screen-2xl gap-8 px-4 pb-4 pt-10 text-black flex-col dark:text-white relative">
        <div className='h-[150px] md:h-[250px] w-full overflow-hidden relative bg-slate-800 flex justify-center items-center'>
          <h2 className='text-white text-2xl md:text-5xl font-bold z-10'>Gracias por visitar nuestra tienda</h2>
